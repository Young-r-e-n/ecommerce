...
<body>
    ...
    <div class="home-section">
        ...
        <section class="home">
            ...
            <div class="img">
                <img src="image/IMG_3764.jpg" alt="">
            </div>
        </section>
        <!-- home content -->
    </div>
        ...
        <div class="row">
            <div class="col-md-4 py-3 py-md-0">
                <div class="card" style="background-color: #a9a9a926;">
                    <img src="image/IMG_3765.jpg" alt="">
                    <div class="card-img-overlay">
                        <h5 class="card-titel">Black Loius Vuitton</h5>
                        <p>Beating cold... do it in style</p>
            ...
            <div class="col-md-4 py-3 py-md-0">
                <div class="card" style="background-color: #a9a9a926;">
                    <img src="image/IMG_3766.jpg" alt="">
                    <div class="card-img-overlay">
                        <h5 class="card-titel">Amiri</h5>
                        <p>Elegance above all... even when you are cold</p>
            ...
            <div class="col-md-4 py-3 py-md-0">
                <div class="card" style="background-color: #a9a9a926;">
                    <img src="image/IMG_3767.jpg" alt="">
                    <div class="card-img-overlay">
                        <h5 class="card-titel">Amiri</h5>
    ...
    <div class="container" id="product-cards">
        ...
        <div class="row" style="margin-top: 30px;">
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="image/IMG_3768.jpg" alt="">
                    <div class="card-body">
                        <h3>The North Face</h3>
                        <p>All sizes ranging from XS to 6XL</p>
                        <div class="star">
                        ...
                        <h5>$92.60 <strike>$100</strike> <span><i class="fa-solid fa-cart-shopping"></i></span></h5>
                    </div>
                </div>
            </div>
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="image/IMG_3769.jpg" alt="">
                    <div class="card-body">
                        <h3>Dragonville</h3>
            ...
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="image/IMG_3770.jpg" alt="">
                    <div class="card-body">
                        <h3>Louis Vuitton</h3>
                        <p>all sizes availble from small to 6XL</p>
                        <div class="star">
            ...
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="image/IMG_3771.jpg" alt="">
                    <div class="card-body">
                        <h3>The North Face X The Army</h3>
                        <p>Sizes large to 6XL.</p>
                        <div class="star">
                            <i class="fas fa-star checked"></i>
                            <i class="fas fa-star checked"></i>
                            <i class="fas fa-star checked"></i>
                        ...
                        <h5>$90.60 <strike>$96.90</strike> <span><i class="fa-solid fa-cart-shopping"></i></span></h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="margin-top: 30px;">
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="image/IMG_3772.jpg" alt="">
                    <div class="card-body">
                        <h3>Essentials Hoodies</h3>
                        <p>Sizes ranging from small to 6XL.</p>
                        <div class="star">
                            <i class="fas fa-star checked"></i>
                            <i class="fas fa-star checked"></i>
                            <i class="fas fa-star checked"></i>
                        ...
                        <h5>$95.60 <strike>$100.50</strike> <span><i class="fa-solid fa-cart-shopping"></i></span></h5>
                    </div>
                </div>
            </div>
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="image/IMG_3773.jpg" alt="">
                    <div class="card-body">
                        <h3>Puffs</h3>
                        <p>all sizes availble from small to 6XL</p>
                        <div class="star">
                        ...
                        <h5>$42.30 <strike>$45</strike> <span><i class="fa-solid fa-cart-shopping"></i></span></h5>
                    </div>
                </div>
            </div>
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="image/IMG_3774.jpg" alt="">
                    <div class="card-body">
                        <h3>College Jacket</h3>
                        <p>all sizes availble from small to 6XL</p>
                        <div class="star">
                            <i class="fas fa-star checked"></i>
                            <i class="fas fa-star checked"></i>
                        ...
                        <h5>$83.2 <strike>$85.60</strike> <span><i class="fa-solid fa-cart-shopping"></i></span></h5>
                    </div>
                </div>
            </div>
            <div class="col-md-3 py-3 py-md-0">
                <div class="card">
                    <img src="image/IMG_3775.jpg" alt="">
                    <div class="card-body">
                        <h3>Tie and Dye</h3>
                        <p>all sizes availble from small to 6XL</p>
                        <div class="star">
                        ...
                        <h5>$110.50 <strike>$115.60</strike> <span><i class="fa-solid fa-cart-shopping"></i></span></h5>
                    </div>
                </div>
            </div>
        </div>
